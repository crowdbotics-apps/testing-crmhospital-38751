...
## Project Structure
    ...
    ├── testing_crmhospital_38751  # Django project configurations
...
1. Clone this repo and `cd testing_crmhospital_38751`
...
2. Clone this repo and `cd testing_crmhospital_38751`
